...
pubDatetime: '2022-03-21T08:00:00.000Z'
tags:
  - .NET 6
  - Serverless
  - AWS
...
In a very similar way to what we have done in the [previous post](/deploy-net-6-blazor-webassembly-aws-elastic-beanstalk/), we are going to create our _AWS CodePipeline_ to build and publish the .NET AWS Lambda function. The _AWS CodePipeline_ will pull the source code from GitHub and then pass the artifact to the build server. 
