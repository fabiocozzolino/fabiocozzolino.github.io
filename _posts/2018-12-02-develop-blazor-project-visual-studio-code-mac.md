...
Be sure to have the latest .NET Core version installed on your development machine. Go to [https://dotnet.microsoft.com/download](https://dotnet.microsoft.com/download)
